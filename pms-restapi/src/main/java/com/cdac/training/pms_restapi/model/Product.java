package com.cdac.training.pms_restapi.model;
...
/**
 * Author : rajgs Date : 31 Dec 2024 Time : 5:03:47 pm
 * 
 * Hibernate with Spring Boot JPA Hibernate is a ORM Tool -> Object - Relational
 * Mapping
 * 
 ...
 * class and relational database. JPA follows Object-Relation Mapping (ORM). It
 * is a set of interfaces. It also provides a runtime EntityManager API for
 * processing queries and transactions on the objects against the database. It
 * uses a platform-independent object-oriented query language JPQL (Java
 * Persistent Query Language). JPA is implemented with Annotations
 */
/*
 * Model class for Managing products using Hibernate -JPA The @Entity annotation
